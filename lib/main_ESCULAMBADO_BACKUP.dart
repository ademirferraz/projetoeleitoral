...
class _TelaAdminLoginState extends State<TelaAdminLogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: const Text('Login Admin'), backgroundColor: Colors.amber[700]), body: SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      ElevatedButton(onPressed: _login, style: ElevatedButton.styleFrom(backgroundColor: Colors.amber, minimumSize: const Size(200, 50)), child: const Text('Entrar', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold))),
    ])));
  }
          ...
          if (_mostrarGerador) ...[
            ...
            if (_senhaGerada.isNotEmpty) ...[
              ...
              Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.grey[800], borderRadius: BorderRadius.circular(8)), child: Column(children: [
                ...
                const SizedBox(height: 8),
                const Text('Copie e use esta senha! Requer: 1 maiuscula, 1 minuscula, 1 numero, 1 especial', textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: Colors.grey)),
              ])),
            ],
          ],
        ],
  ...
  Widget _tabCandidatos() {
    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            ElevatedButton(onPressed: _injectVotes, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF008F39)), child: const Text('Injetar Votos', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
            const SizedBox(width: 8),
            ElevatedButton(onPressed: _clearVotes, style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFB24040)), child: const Text('Limpar Votos', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
          ],
        ),
        const SizedBox(height: 16),
        Expanded(
