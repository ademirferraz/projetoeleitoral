//o GridView não existe entao onde inserir-->>// No seu main.dart, dentro do GridView:
//_itemMenu(context, 'COLETA', Icons.add_chart, Colors.blue, const TelaPesquisa()),
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () => Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            const TelaResultados(estado: null, city: ''),
                      ),
                    ),
                    child: const Text(
                      'RESULTADOS',
              ...
              children: [
                ...
                if (_tipoUsuario == 'eleitor')
                  ...
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const TelaAdminLogin()),
                    ),
                  ...
                  ElevatedButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const TelaPesquisador(),
                      ),
                    ),
...
class _Tela1CadastroState extends State<Tela1Cadastro> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) =>
                    v?.isEmpty ?? true ? 'Bairro obrigatório' : null,
              ),
  ...
  void _cadastrar() {
    ...
    // Check for duplicate CPF before registration
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => Tela2Votacao(eleitor: eleitor)),
    );
  }
}
...
class _Tela2VotacaoState extends State<Tela2Votacao> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'Eleitor: ${widget.eleitor.nome}',
              style: const TextStyle(fontWeight: FontWeight.w900),
            ),
            Text(
              'Bairro: ${widget.eleitor.bairro}',
              style: const TextStyle(fontWeight: FontWeight.w900),
            ),
            const SizedBox(height: 10),
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Card(
                    child: RadioListTile<String>(
                      ...
                      onChanged: jaVotou
                          ? null
                          : (v) => setState(() => _candSel = v),
                      secondary: c.fotoPath != null
                          ? ClipRRect(
                              borderRadius: BorderRadius.circular(8),
                              child: Image.memory(
                                base64Decode(c.fotoPath!),
                                width: 50,
                                height: 50,
                                fit: BoxFit.cover,
                              ),
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          if (c.estado != null || c.cidade != null)
                            Text(
                              '${c.cidade ?? ''}${c.cidade != null && c.estado != null ? '/' : ''}${c.estado ?? ''}',
                              style: const TextStyle(
                                fontSize: 12,
            ...
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: _candSel == null || jaVotou ? null : _votar,
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF008F39),
                foregroundColor: Colors.white,
                minimumSize: const Size.fromHeight(50),
  ...
  void _votar() async {
    ...
    await DatabaseService.saveVoto(
      Voto(
        idEleitor: widget.eleitor.id,
        idCandidato: _candSel!,
        tipoVoto: _tipo,
...
class _TelaAdminState extends State<TelaAdmin> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [_tabFiltros(), _tabCandidatos(), _tabQGP(), _tabTestes()],
        ),
      ),
    );
  }
        ...
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () => Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) =>
                    TelaResultados(estado: _estado, city: _cityController.text),
              ),
            ),
            ...
            child: Row(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFFB24040),
                    foregroundColor: Colors.white,
                  ),
                ),
              ],
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: _bytesFoto != null
                      ? DecorationImage(
                          image: MemoryImage(_bytesFoto!),
                          fit: BoxFit.cover,
                        )
                      : null,
          ...
          child: ListView.builder(
            ...
            itemBuilder: (ctx, i) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  '${c.partido} - ${c.numero}${c.estado != null ? ' | ${c.cidade ?? ''}/${c.estado}' : ''}',
                  style: const TextStyle(
                    fontWeight: FontWeight.w900,
                    fontSize: 12,
                  ),
  ...
  Widget _buildChart() {
    ...
    double maxPerc = t > 0
        ? c.map((x) => (x.votos / t) * 100).reduce((a, b) => a > b ? a : b)
        : 0;
          ...
          children: [
            ...
            if (_cands.isEmpty)
              const Padding(
                ...
                child: Text(
                  'Cadastre candidatos primeiro para usar a injeção de votos.',
                  style: TextStyle(
                    color: Colors.amber,
                    fontWeight: FontWeight.bold,
                  ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: DropdownButtonFormField<String>(
                      value:
                          (_votosCandSelecionado == 'random' ||
                              _cands.any((c) => c.id == _votosCandSelecionado))
                          ? _votosCandSelecionado
                          : 'random',
                      decoration: const InputDecoration(
                        labelText: 'Candidato Destino',
                        border: OutlineInputBorder(),
                      ),
                      items: [
                        const DropdownMenuItem(
                          value: 'random',
                          child: Text('Aleatório (Padrão 30)'),
                        ),
                        ..._cands.map(
                          (c) => DropdownMenuItem(
                            value: c.id,
                            child: Text('${c.nome} (${c.numero})'),
                          ),
                        ),
                      ],
                      onChanged: (v) =>
                          setState(() => _votosCandSelecionado = v ?? 'random'),
                    ),
                  ),
                ],
              ),
  ...
  void _addCandidato() {
    if (_nameController.text.isEmpty ||
        ...
        _partidoController.text.isEmpty)
      return;
  ...
  void _gerarEleitores() {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('50 Eleitores Gerados!')));
  }
  ...
  void _gerarVotos() {
    ...
    String destino = _votosCandSelecionado ?? 'random';

    for (int i = 0; i < qtd; i++) {
      String candId;
      if (destino == 'random') {
        candId = _cands[i % _cands.length].id;
      } else {
        candId = destino;
      }
      DatabaseService.saveVoto(
        Voto(
          idEleitor: 't_custom_${DateTime.now().millisecondsSinceEpoch}_$i',
          idCandidato: candId,
          tipoVoto: 'presidente',
          dataVoto: DateTime.now(),
        ),
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('$qtd Votos Injetados com Sucesso!')),
    );
  }
  ...
  void _limpar() {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(const SnackBar(content: Text('Banco de Dados Limpo!')));
  }
}
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final cand = c[i];
                  final perc = t > 0 ? (cand.votos / t) * 100 : 0.0;
                  return ListTile(
                    leading: cand.fotoPath != null
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(8),
                            child: Image.memory(
                              base64Decode(cand.fotoPath!),
                              width: 40,
                              height: 40,
                              fit: BoxFit.cover,
                            ),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: t == 0
                  ? const Center(child: Text('Aguardando votos...'))
                  : PieChart(
                      PieChartData(
                        sections: c.map((cand) {
                          return PieChartSectionData(
                            value: cand.votos.toDouble(),
                            title: cand.sigla,
                            radius: 100,
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 20),
            const Text(
              'DADOS DO ENTREVISTADO (OPCIONAL)',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w900),
            ),
            const SizedBox(height: 10),
            TextField(
